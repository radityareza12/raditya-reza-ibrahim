              ...
              <table class="table table-bordered" id="myTable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">NIS</th>
                    <th scope="col">tgl_pembayaran</th>
                    <th scope="col">jumlah_pembayaran</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edit.php?id=<?php echo $row['id_pembayaran'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus.php?id=<?php echo $row['id_pembayaran'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>
